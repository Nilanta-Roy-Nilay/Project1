            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text('AI is thinking...', style: TextStyle(color: Theme.of(context).hintColor)),
                ],
              ),
            ),
          _buildMessageInput(),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: isUser ? Colors.white70 : Theme.of(context).hintColor, fontSize: 11),
                  ),
                ],
              ),
            ),
