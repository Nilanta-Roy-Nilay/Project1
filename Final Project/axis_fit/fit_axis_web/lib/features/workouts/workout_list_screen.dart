  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              return Dismissible(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text(log.type, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    subtitle: Text(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => _showAddWorkoutSheet(context, user.uid, firestoreService),
        child: const Icon(Icons.add, color: Colors.black),
      ),
    );
  }

  void _showAddWorkoutSheet(BuildContext context, String uid, FirestoreService service) async {
